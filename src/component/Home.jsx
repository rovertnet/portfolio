      ...
      <div className="block">
        ...
        >
          ...
          >
            ...
            <h2 className="font-bold dark:text-white text-green-700 md:text-2xl text-2xl">
              -Développeur Web
            </h2>
            <p className=" text-lg md:text-xl px-7 max-w-md text-slate-500 dark:text-gray-300 mb-3">
              En tant que Développeur Web passionné, je conçois des expériences
              en ligne exceptionnelles en utilisant des langages tels que HTML,
