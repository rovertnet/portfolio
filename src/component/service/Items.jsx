...
function Items({title, icon, describe}) {
  return (
    <div className="bg-slate-300 md:px-10 p-5 transition rounded-md md:mx-8 mx-6 md:my-4 my-2 md:py-3 lg:py-3 sm:py-3 py-3 hover:bg-slate-200 cursor-pointer dark:bg-slate-800 dark:hover:bg-slate-700">
